package com.banking.demo.BankingDemoWithoutDB.service;
...
import com.banking.demo.BankingDemoWithoutDB.repository.BankRepository;
...
public class BankService {
	...
	public boolean createAccount(Account acc) {
		return bankRepository.createAccount(acc);
	}
	...
	public Account getAccountByNumber(Integer accountNumber) {
		return bankRepository.findAccountById(accountNumber);
	}
}
